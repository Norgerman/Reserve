...
<head>
    ...
    {{HTML::style("lib/daterangepicker/daterangepicker-bs3.css")}}
    ...
    {{HTML::script("lib/daterangepicker/moment.min.js")}}
    {{HTML::script("lib/daterangepicker/daterangepicker.js")}}
    <style>
...
//                    formatter: sexFormatter, unformat: sexUnFormatter }
        ...
        jQuery(grid_selector2).jqGrid({
            ...
            // 表头
            colNames: [' ', 'ID', '用户名', '密码', '姓名', '电话', "简介", '权限'],
...
//                    formatter: sexFormatter, unformat: sexUnFormatter }
        ...
        jQuery(grid_selector3).jqGrid({
            ...
            colModel: [
                ...
                {name: 'am', index: 'am', width: 80, sortable: false, editable: true},
                {name: 'pm', index: 'pm', width: 80, sortable: false, editable: true},
...
//                    formatter: sexFormatter, unformat: sexUnFormatter }
        ...
        function style_edit_form_visit(form) {
            //enable datepicker on "sdate" field and switches for "stock" field
            form.find('input[name=work_date]').daterangepicker({ singleDatePicker: true, format: "YYYY-MM-DD" }, function(start, end, label) {
